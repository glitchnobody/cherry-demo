...
const OPEN_CODE_RESPONSE_LINES = [
  ...
  { kind: "disclosure", text: "[sponsored]" },
  {
    kind: "copy",
    ...
    <WindowShell app="miro" title="Miro" onClose={onClose}>
      <div className="miro-app">
        ...
        <div className="miro-board">
          ...
          {step === 1 && <div className="miro-generating"><div className="miro-generation-status"><div className="miro-spinner" /><div><small>MIRO AI</small><strong>{loadingMessages[loadingMessage]}</strong></div></div><div className="miro-progress"><i /></div><aside className="miro-loading-sponsor"><div><div className="miro-sponsor-title"><strong>RevenueCat</strong><span className="miro-sponsor-pill">Sponsored</span></div><p>Subscriptions and trials for mobile apps</p></div><button type="button">Learn more ↗</button></aside></div>}
          {step === 2 && <div className="miro-canvas">
            ...
            <aside className="miro-drag-sponsor"><span className="miro-sponsor-pill">Sponsored</span><strong>RevenueCat</strong><p>Add subscriptions and trials to FitFlow.</p><button type="button">Explore setup →</button></aside>
